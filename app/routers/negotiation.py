...
# --- Financial Offers Engine ---

from app.schemas.negotiation import OfferCreate, OfferResponse

@router.post("/rooms/{room_id}/offers", response_model=OfferResponse, status_code=status.HTTP_201_CREATED)
...
@router.get("/rooms/{room_id}/offers", response_model=List[OfferResponse])
